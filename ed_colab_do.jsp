...
<body>
	...
	Class.forName("com.mysql.jdbc.Driver");
        ...
        PreparedStatement ps = conn.prepareStatement("UPDATE colaboradores SET cl_nome = '"+nome+"', cl_pass = '"+pass+"', cl_login = '"+login+"', cl_email = '" + email + "', cl_nivel = " + nivel + " WHERE cl_id = " + request.getParameter("id") );
...
<br/>
        		 <div class="box box-success"><p>Colaborador modificado com sucesso</p>                  
                         </div>	
                              <br/>
